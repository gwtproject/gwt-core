...
public class JsIdentityTest extends GWTTestCase {
    ...
    public void testJsoJavaComparison() {
        storeJsoIdentity();
        com.google.gwt.core.client.JavaScriptObject obj1 = getJsoIdentity();
        com.google.gwt.core.client.JavaScriptObject obj2 = getJsoIdentity();
    ...
    public void testJavaArrayArray() {
        Object id1 = new Object();
        Object id2 = new Object();
        JsArray<JsoTestArray<Object>> elements = com.google.gwt.core.client.JavaScriptObject.createArray().cast();
    ...
    static final class JsoTestArray<T> extends com.google.gwt.core.client.JavaScriptObject {
