 ...
 *
 * <p>Deprecated: just use JSON.parse and JSON.stringify.
 */
@Deprecated
public class JsonUtils {
  ...
  /**
   * Escapes characters within a JSON string than cannot be passed directly to eval(). Control
  ...
  public static String escapeJsonForEval(String toEscape) {
    ...
    //        var s =
    // toEscape.replace(/[\xad\u0600-\u0603\u06dd\u070f\u17b4\u17b5\u200b-\u200f\u2028-\u202e\u2060-\u2064\u206a-\u206f\ufeff\ufff9-\ufffb]/g, function(x) {
  ...
  public static String escapeValue(String toEscape) {
    ...
    //        JsArray<JsString> escapeTable = getEscapeTable();
    //        var s =
    // toEscape.replace(/[\x00-\x1f\xad\u0600-\u0603\u06dd\u070f\u17b4\u17b5\u200b-\u200f\u2028-\u202e\u2060-\u2064\u206a-\u206f\ufeff\ufff9-\ufffb"\\]/g, function(x) {
    //            return @JsonUtils::escapeChar(*)(x, escapeTable);
    //        });
    //      return "\"" + s + "\"";
  }
  ...
  /**
   * Evaluates a JSON expression safely. The payload must evaluate to an Object or an Array (not a
  ...
  /**
   * Returns true if the given JSON string may be safely evaluated by {@code eval()} without
   * undesired side effects or security risks. Note that a true result from this method does not
   * guarantee that the input string is valid JSON. This method does not consider the contents of
   * quoted strings; it may still be necessary to perform escaping prior to evaluation for correct
   * results.
   *
   * <p>The technique used is taken from <a href="http://www.ietf.org/rfc/rfc4627.txt">RFC 4627</a>.
   *
   * <p>Note that this function may fail in sufficiently large text in some browsers (e.g. Chrome).
   * It is always better to use {@link #safeEval} instead which is safer, faster and also works with
  ...
  /**
   * Evaluates a JSON expression using {@code eval()}. This method does not validate the JSON text
   * and should only be used on JSON from trusted sources. The payload must evaluate to an Object or
