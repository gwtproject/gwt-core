...
//  }
//
//  private native boolean compareObjects(JavaScriptObject expected, JavaScriptObject actual) /*-{
//      for (key in expected) {
...
//    }-*/;
  ...
  private static JsArrayMixed makeArray() {
    JsArrayMixed array = new JsArrayMixed();
    array.push(true);
    array.push(2.5);
    array.push(1);
    array.push(JsonUtils.safeToEval( "{kind: \"pear\"}"));
    array.push("orange");
    return array;
  }
...
//    }-*/;
//
//  private JsTestFruit makeOJavaS{kind: theKind} {
//    return JavaScriptObject.crea
//    }
}
